    ...
    switch (normalizedRole) {
      ...
      case "TUTOR":
        return {
          main: [
            ...
            {
              id: "genius-verification",
              label: "Genius / Verification Request",
              icon: Shield,
            },
      ...
      case "SUPER_ADMIN":
        return {
          main: [
            ...
            {
              id: "admin-tuition-request",
              label: "Create Tuition Requests",
              icon: PlusCircle,
            },
          ...
          quick: [
            {
              ...
              subMenus: [
                ...
                { id: "fee", label: "Platform Fee", icon: DollarSignIcon },
          ...
          account: [{ id: "profile", label: "Profile Settings", icon: User }],
        };
      case "ADMIN":
        return {
          main: [
      ...
      default:
        ...
        return {
          ...
          quick: [],
          account: [{ id: "settings", label: "Settings", icon: Settings }],
        };
    }
  };
  ...
  const renderMenuItem = (item: any) => {
    ...
    return (
      <div key={item.id} className="space-y-1">
        ...
        >
          {IconComponent && (
            <IconComponent className="h-4 w-4 sm:h-5 sm:w-5 mr-3" />
          )}
          <span className="font-medium text-xs sm:text-sm lg:text-base flex-1 text-left">
            {item.label}
          </span>
          {hasSubMenus && (
        ...
        <div className="space-y-6">
          ...
          {role === "STUDENT_GUARDIAN" && (
            <div className="flex flex-col items-center text-center p-4 bg-green-600 text-white rounded-lg shadow-md mb-6">
              ...
              <p className="text-sm text-green-100">+8801516-528101</p>
            </div>
          )}
          ...
          {user && (
            <div className="flex flex-col items-center text-center p-4 bg-green-600 text-white rounded-lg shadow-md mb-6">
              ...
              <p className="text-xs text-green-200">
                {user.role === "TUTOR" &&
                  `Tutor ID: ${user.tutor_id || "N/A"} | `}
                Role: {user.role?.replace(/_/g, " ").toUpperCase() || "N/A"} |
