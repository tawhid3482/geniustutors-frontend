...
export const HeroSection = () => {
  ...
  console.log("Area Tutors Data:", areaTutorsData);
  ...
  console.log("District Jobs Data:", districtJobsData);
  ...
  useEffect(() => {
    if (areaTutorsData && Array.isArray(areaTutorsData)) {
      console.log("Processing area tutors data:", areaTutorsData);
      
      const processedTutors: any[] = areaTutorsData.map((area: any) => ({
  ...
  useEffect(() => {
    if (districtJobsData && Array.isArray(districtJobsData)) {
      console.log("Processing district jobs data:", districtJobsData);
      
      const processedDivisions: Division[] = districtJobsData.map((district: any) => ({
        id: district.id,
        name: district.name,
