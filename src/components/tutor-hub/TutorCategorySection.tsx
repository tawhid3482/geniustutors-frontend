...
//   const {data:categoryTutorData}=useGetAllTutorHubByCategoryQuery(undefined)
//   console.log(categoryTutorData)

//   useEffect(() => {
//     const fetchTutors = async () => {
//       try {
//         setLoading(true);
//         // Fetch at least 8 tutors for better sliding experience
//         const fetchLimit = Math.max(limit, 8);
//         const response = await fetch(`/api/tutor-hub?category=${category}&limit=${fetchLimit}`);
//         if (response.ok) {
//           const data = await response.json();
//           setTutors(data.tutors || []);
//         } else {
//           // Fallback to mock data if API fails
//           setTutors(getMockTutors(category, fetchLimit));
//         }
//       } catch (error) {
//         console.error(`Error fetching ${category} tutors:`, error);
//         // Fallback to mock data
//         setTutors(getMockTutors(category, Math.max(limit, 8)));
//       } finally {
//         setLoading(false);
//       }
//     };
...
//   const getMockTutors = (category: string, limit: number): Tutor[] => {
//     const mockTutors: Tutor[] = [
//       {
//         id: '1',
//         tutor_id: 'TUT001',
//         full_name: 'Toutikul Islam',
//         university_name: 'National Institute D.',
//         location: 'Dhaka',
//         gender: 'male',
//         verified: 1,
//         premium: 'no'
...
//         id: '3',
//         tutor_id: 'TUT003',
//         full_name: 'Feha Anjum D.',
//         university_name: 'Lalmatia Govt. Mohil',
//         location: 'Dhaka',
//         gender: 'female',
//         verified: 1,
//         premium: 'no'
...
//         id: '5',
//         tutor_id: 'TUT005',
//         full_name: 'Hasibul Hasan',
//         university_name: 'Dhaka Commerce Colle',
//         location: 'Dhaka',
//         gender: 'male',
//         verified: 1,
//         premium: 'yes'
...
//         id: '10',
//         tutor_id: 'TUT010',
//         full_name: 'Rahman Ali',
//         university_name: 'CUET',
//         location: 'Chittagong',
//         gender: 'male',
//         verified: 1,
//         premium: 'no'
...
//       filteredTutors = mockTutors.filter(t => t.verified === 1);
//     } else if (category === 'genius') {
//       filteredTutors = mockTutors.filter(t => t.premium === 'yes');
//     } else if (category === 'new') {
//       filteredTutors = mockTutors.slice(0, 8); // Simulate new tutors
//     }

//     return filteredTutors.slice(0, limit);
//   };
...
//             style={{
//               transform: `translateX(-${currentIndex * (256 + 12)}px)`, // 256px card width + 12px gap for mobile
//               width: `${tutors.length * (256 + 12)}px` // Total width for all cards
//             }}
//           >
...
export const TutorCategorySection = ({ title, category, limit }: TutorCategorySectionProps) => {
  ...
  // Use RTK Query with category parameter
  ...
  console.log(`${category} tutors:`, tutors);
