...
export const TutorSignupForm: React.FC<TutorSignupFormProps> = ({ 
  ...
  const handleTutorSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('🔍 TutorSignupForm - Registration payload prepared:', registrationPayload);
      
      // Show phone verification dialog with registration payload
      console.log('🔄 TutorSignupForm - Calling onPhoneVerification with registrationPayload...');
      onPhoneVerification(tutorFormData.phone, tutorFormData.fullName, registrationPayload);
      console.log('✅ TutorSignupForm - Phone verification dialog should now be visible for tutor');
      setLoading(false);
  ...
  return (
    <form onSubmit={handleTutorSubmit} className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        {/* Email */}
        <div className="space-y-2">
          <Label htmlFor="tutorEmail" className="text-sm font-semibold text-green-800">Email Address (Optional)</Label>
          <div className="relative">
        ...
        {/* Mobile Number */}
        <div className="space-y-2">
          <Label htmlFor="tutorPhone" className="text-sm font-semibold text-green-800">Mobile Number *</Label>
          <div className="relative">
        ...
        <div className="space-y-2">
          <Label htmlFor="alternativePhone" className="text-sm font-semibold text-green-800">Alternative Number</Label>
          <Input
            id="alternativePhone"
        ...
        {/* University Name */}
        <div className="space-y-2">
          <Label htmlFor="universityName" className="text-sm font-semibold text-green-800">Institute Name *</Label>
          <Input
            id="universityName"
            name="universityName"
            type="text"
        ...
        {/* Department */}
        <div className="space-y-2">
          <Label htmlFor="departmentName" className="text-sm font-semibold text-green-800">Department *</Label>
          <Input
            id="departmentName"
            name="departmentName"
            type="text"
        ...
        {/* Preferred Areas */}
        <div className="space-y-2">
          <Label htmlFor="preferredAreas" className="text-sm font-semibold text-green-800">Preferred Areas *</Label>
          <MultiSelect
        ...
        {/* Background */}
        <div className="space-y-2">
          <Label htmlFor="background" className="text-sm font-semibold text-green-800">Background</Label>
          <MultiSelect
