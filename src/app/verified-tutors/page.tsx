      ...
      <div className="flex-1 w-full mx-auto overflow-x-hidden p-4 sm:p-6">
        <div className="mb-8 w-full mx-auto text-center">
          ...
          <p className="text-gray-600">
            Meet our verified and trusted tutors who have undergone thorough
            verification
          </p>
          ...
          <div className="flex items-center justify-center my-2 gap-3">
            ...
            <span className="text-sm text-gray-700 text-center">
              {verifiedTutors.length} verified tutors available
            </span>
          </div>
        </div>
        ...
        {verifiedTutors.length === 0 ? (
          <div className="text-center py-10 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-500 text-lg">No verified tutors found</p>
            <p className="text-gray-400 text-sm mt-2">
              Check back later for verified tutors
            </p>
          </div>
        ) : (
