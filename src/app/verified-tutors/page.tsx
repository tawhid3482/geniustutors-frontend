...
export default function VerifiedTutors() {
  ...
  const [verifiedTutorOnly, setVerifiedTutorOnly] = useState(true);
      ...
      <div className="container mx-auto py-4 sm:py-6 md:py-8 px-3 sm:px-4 md:px-6 lg:px-8 overflow-x-hidden w-full">
        <div className="flex flex-col space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col space-y-2">
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Verified Tutors</h1>
            <p className="text-muted-foreground text-sm sm:text-base">Connect with our verified and trusted tutors who have been thoroughly vetted</p>
          </div>
