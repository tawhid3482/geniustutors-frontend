      ...
      <div className="container mx-auto py-4 sm:py-6 md:py-8 px-3 sm:px-4 md:px-6 lg:px-8 overflow-x-hidden w-full">
        <div className="flex flex-col space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col space-y-2">
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">New Tutors</h1>
            <p className="text-muted-foreground text-sm sm:text-base">Discover our newest tutors who have recently joined our platform</p>
          </div>
                ...
                <CardContent className="space-y-4 sm:space-y-6 p-4 sm:p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={sortBy} onValueChange={setSortBy}>
                      ...
                      <SelectContent>
                        <SelectItem value="created_at" className="font-bold">Registration Date</SelectItem>
